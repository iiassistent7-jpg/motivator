...
Коротко (3-7 предложений). Конкретно. НЕ используй звёздочки, подчёркивания или Markdown — ТОЛЬКО чистый текст и эмодзи. Тон зависит от времени суток.
Обращайся: Соломонович или Михаил Соломонович."""
